...
from kb_ea_utils.kb_ea_utilsImpl import kb_ea_utils  # @IgnorePep8
...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_kb_ea_utils.get_fastq_ea_utils_stats,
                             ...
                             types=[dict])
        self.method_authentication['kb_ea_utils.get_fastq_ea_utils_stats'] = 'required'
        self.rpc_service.add(impl_kb_ea_utils.run_app_fastq_ea_utils_stats,
                             name='kb_ea_utils.run_app_fastq_ea_utils_stats',
                             types=[dict])
        self.method_authentication['kb_ea_utils.run_app_fastq_ea_utils_stats'] = 'required'
                ...
                try:
                    ...
                    if auth_req != 'none':
                        if token is None and auth_req == 'required':
                            err = JSONServerError()
                            err.data = (
                                'Authentication required for kb_ea_utils ' +
